...
const UsersTable = () => {
  ...
  const [newUser, setNewUser] = useState({ nombre: '', email: '', password: '', roletype_id: null });
  ...
  const handleCreateUser = () => {
    fetch('/api/usuarios', {
      ...
      .then((user) => {
        setUsers([...users, user]);
        setNewUser({ nombre: '', email: '', password: '', roletype_id: null });
  ...
  return (
    <div className="admin-layout">
      ...
      >
        <h2 style={{ color: '#ffffff', display: 'inline-block' }}>Gestión de Usuarios</h2>
        {/* Tabla de usuarios */}
        ...
        <div>
          ...
          <label>
            ...
            <input
              ...
              onChange={(e) => setNewUser({ ...newUser, roletype_id: parseInt(e.target.value) || null })}
            />
          </label>
          <br />
          ...
          <div>
            ...
            <label>
              ...
              <input
                ...
                onChange={(e) => setEditingUser({ ...editingUser, roletype_id: parseInt(e.target.value) || null })}
              />
            </label>
            <br />
